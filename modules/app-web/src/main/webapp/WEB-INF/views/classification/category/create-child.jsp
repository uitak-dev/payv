...
<div class="app-shell shadow-sm">
    <header class="sticky top-0 z-30 border-b border-slate-200 bg-white">
        <div class="flex items-center justify-between px-4 py-3">
            ...
            <h1 class="text-base font-semibold">2단계 카테고리 생성</h1>
    ...
    <main class="px-4 pt-4 pb-24">
        ...
        <form class="space-y-4" method="post" action="${ctx}/api/classification/categories/roots/${root.categoryId}/children" data-ajax="true">
            <section class="pv-card p-4">
                ...
                <label class="mt-4 block">
                    ...
                    <input name="name" required class="mt-2 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm" placeholder="예: 카페/커피"/>
                </label>
            </section>
            <button type="submit" class="w-full rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white">생성</button>
        </form>
    </main>
</div>
