...
<div class="app-shell shadow-sm">
    <header class="sticky top-0 z-30 border-b border-slate-200 bg-white">
        <div class="flex items-center justify-between px-4 py-3">
            ...
            <h1 class="text-base font-semibold">1단계 카테고리 수정</h1>
    ...
    <main class="px-4 pt-4 pb-24">
        ...
        <form class="space-y-4" method="post" action="${ctx}/api/classification/categories/roots/${root.categoryId}" data-ajax="true" data-method="PUT">
            <section class="pv-card p-4">
                <label>
                    <div class="text-sm font-medium">카테고리 이름</div>
                    <input name="newName" value="${root.name}" required class="mt-2 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"/>
                </label>
            </section>
