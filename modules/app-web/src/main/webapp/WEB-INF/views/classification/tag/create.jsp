...
<div class="app-shell shadow-sm">
    <header class="sticky top-0 z-30 border-b border-slate-200 bg-white">
        <div class="flex items-center justify-between px-4 py-3">
            ...
            <h1 class="text-base font-semibold">태그 생성</h1>
        ...
        <form class="space-y-4" method="post" action="${ctx}/classification/tags" data-ajax="true">
            <section class="pv-card p-4">
                <label>
                    ...
                    <input name="name" required class="mt-2 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm" placeholder="예: 회사"/>
                </label>
            </section>
