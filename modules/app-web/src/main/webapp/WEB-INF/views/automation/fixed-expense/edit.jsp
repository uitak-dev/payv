            ...
            <section class="pv-card p-4">
                <div class="grid gap-4">
                    ...
                    <div>
                        ...
                        <input id="scheduleType" name="scheduleType" type="hidden" value="${fixedExpense.endOfMonth ? 'EOM' : 'DAY'}"/>
                        <div class="mt-2 flex items-center gap-3">
                            <input id="dayOfMonth" name="dayOfMonth" type="number" min="1" max="31" required class="w-32 rounded-xl border border-slate-200 px-3 py-2 text-sm" value="${fixedExpense.dayOfMonth}"/>
                            <label for="endOfMonthCheck" class="inline-flex items-center gap-2 text-sm text-slate-700">
                                <input id="endOfMonthCheck" type="checkbox" class="h-4 w-4 rounded border-slate-300" ${fixedExpense.endOfMonth ? 'checked' : ''}/>
                                <span>EOM(매월 말일)</span>
                            </label>
                        </div>
