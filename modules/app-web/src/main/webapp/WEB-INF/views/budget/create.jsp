...
<div class="app-shell shadow-sm">
    <header class="sticky top-0 z-30 border-b border-slate-200 bg-white">
        <div class="flex items-center justify-between px-4 py-3">
            <a href="${ctx}/budget/budgets?month=${selectedMonth}" class="rounded-lg border border-slate-200 px-3 py-1.5 text-sm">뒤로</a>
            <h1 class="text-base font-semibold">예산 생성</h1>
            ...
            <section class="pv-card p-4">
                <div class="grid gap-4">
                    <label>
                        ...
                        <input name="month" type="month" required value="${selectedMonth}" class="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"/>
                    </label>
